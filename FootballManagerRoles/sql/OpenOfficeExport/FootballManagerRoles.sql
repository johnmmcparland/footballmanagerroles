...
CREATE CACHED TABLE "CategoriesOutfield"("Category" VARCHAR(50) NOT NULL PRIMARY KEY)
CREATE CACHED TABLE "CategoriesGK"("Category" VARCHAR(50) NOT NULL PRIMARY KEY)
CREATE CACHED TABLE "TypesOutfield"("Type" VARCHAR(50) NOT NULL PRIMARY KEY)
CREATE CACHED TABLE "TypesGK"("Type" VARCHAR(50) NOT NULL PRIMARY KEY)
CREATE CACHED TABLE "AttributesOutfield"("Attribute" VARCHAR(50) NOT NULL PRIMARY KEY,"Type" VARCHAR(50) NOT NULL,"Category" VARCHAR(50) NOT NULL,CONSTRAINT SYS_FK_113 FOREIGN KEY("Category") REFERENCES "CategoriesOutfield"("Category"),CONSTRAINT SYS_FK_119 FOREIGN KEY("Type") REFERENCES "TypesOutfield"("Type"))
CREATE CACHED TABLE "AttributesGK"("Attribute" VARCHAR(50) NOT NULL PRIMARY KEY,"Type" VARCHAR(50) NOT NULL,"Category" VARCHAR(50) NOT NULL,CONSTRAINT SYS_FK_108 FOREIGN KEY("Category") REFERENCES "CategoriesGK"("Category"),CONSTRAINT SYS_FK_122 FOREIGN KEY("Type") REFERENCES "TypesGK"("Type"))
CREATE CACHED TABLE "Positions_To_Roles"("PitchArea" VARCHAR(30) NOT NULL,"Side" VARCHAR(10) NOT NULL,"Role" VARCHAR(50) NOT NULL,"Duty" VARCHAR(10) NOT NULL,"ViewName" VARCHAR(50) NOT NULL,PRIMARY KEY("PitchArea","Side","Role","Duty","ViewName"))
CREATE CACHED TABLE "PitchArea"("PitchArea" VARCHAR(30) NOT NULL PRIMARY KEY)
CREATE CACHED TABLE "Side"("Side" VARCHAR(10) NOT NULL PRIMARY KEY)
CREATE CACHED TABLE "Role"("Role" VARCHAR(50) NOT NULL PRIMARY KEY)
CREATE CACHED TABLE "Duty"("Duty" VARCHAR(10) NOT NULL PRIMARY KEY)
...
CREATE VIEW "BWM_D" ("Attribute","Type","Category") AS SELECT "Attribute" AS "Attribute", "Type" AS "Type", "Category" AS "Category" FROM "AttributesOutfield" WHERE ( "Attribute" = 'Marking' OR "Attribute" = 'Tackling' OR "Attribute" = 'Aggression' OR "Attribute" = 'Bravery' OR "Attribute" = 'Determination' OR "Attribute" = 'Positioning' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Work Rate' OR "Attribute" = 'Stamina' OR "Attribute" = 'Strength' ) ORDER BY "Attribute" ASC
CREATE VIEW "AP_S" ("Attribute","Type","Category") AS SELECT "Attribute" AS "Attribute", "Type" AS "Type", "Category" AS "Category" FROM "AttributesOutfield" WHERE ( "Attribute" = 'First Touch' OR "Attribute" = 'Passing' OR "Attribute" = 'Technique' OR "Attribute" = 'Creativity' OR "Attribute" = 'Decisions' OR "Attribute" = 'Flair' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Work Rate' OR "Attribute" = 'Stamina' ) ORDER BY "Attribute" ASC
...
CREATE VIEW "LD_D" ("Attribute","Type","Category") AS SELECT "Attribute" AS "Attribute", "Type" AS "Type", "Category" AS "Category" FROM "AttributesOutfield" WHERE ( "Attribute" = 'Marking' OR "Attribute" = 'Tackling' OR "Attribute" = 'Determination' OR "Attribute" = 'Positioning' OR "Attribute" = 'Jumping' OR "Attribute" = 'Strength' ) ORDER BY "Attribute" ASC
CREATE VIEW "LD_S" ("Attribute","Type","Category") AS SELECT "Attribute" AS "Attribute", "Type" AS "Type", "Category" AS "Category" FROM "AttributesOutfield" WHERE ( "Attribute" = 'Marking' OR "Attribute" = 'Tackling' OR "Attribute" = 'Aggression' OR "Attribute" = 'Bravery' OR "Attribute" = 'Determination' OR "Attribute" = 'Positioning' OR "Attribute" = 'Jumping' OR "Attribute" = 'Strength' ) ORDER BY "Attribute" ASC
CREATE VIEW "BWM_S" ("Attribute","Type","Category") AS SELECT "Attribute" AS "Attribute", "Type" AS "Type", "Category" AS "Category" FROM "AttributesOutfield" WHERE ( "Attribute" = 'Marking' OR "Attribute" = 'Passing' OR "Attribute" = 'Tackling' OR "Attribute" = 'Aggression' OR "Attribute" = 'Bravery' OR "Attribute" = 'Determination' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Work Rate' OR "Attribute" = 'Stamina' OR "Attribute" = 'Strength' ) ORDER BY "Attribute" ASC
CREATE VIEW "AP_A" ("Attribute","Type","Category") AS SELECT "Attribute" AS "Attribute", "Type" AS "Type", "Category" AS "Category" FROM "AttributesOutfield" WHERE ( "Attribute" = 'Dribbling' OR "Attribute" = 'First Touch' OR "Attribute" = 'Passing' OR "Attribute" = 'Technique' OR "Attribute" = 'Anticipation' OR "Attribute" = 'Creativity' OR "Attribute" = 'Decisions' OR "Attribute" = 'Flair' OR "Attribute" = 'Off The Ball' OR "Attribute" = 'Teamwork' ) ORDER BY "Attribute" ASC
CREATE VIEW "DLF_A" ("Attribute","Type","Category") AS SELECT "Attribute", "Type", "Category" FROM "AttributesOutfield" WHERE ( "Attribute" = 'Finishing' OR "Attribute" = 'First Touch' OR "Attribute" = 'Passing' OR "Attribute" = 'Technique' OR "Attribute" = 'Anticipation' OR "Attribute" = 'Composure' OR "Attribute" = 'Creativity' OR "Attribute" = 'Decisions' OR "Attribute" = 'Off The Ball' OR "Attribute" = 'Balance' )
CREATE VIEW "AF_A" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'Crossing' OR "Attribute" = 'Dribbling' OR "Attribute" = 'Finishing' OR "Attribute" = 'Heading' OR "Attribute" = 'Anticipation' OR "Attribute" = 'Composure' OR "Attribute" = 'Flair' OR "Attribute" = 'Off The Ball' OR "Attribute" = 'Work Rate' OR "Attribute" = 'Pace' )
...
CREATE VIEW "CM_A" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'Dribbling' OR "Attribute" = 'Finishing' OR "Attribute" = 'First Touch' OR "Attribute" = 'Long Shots' OR "Attribute" = 'Passing' OR "Attribute" = 'Creativity' OR "Attribute" = 'Decisions' OR "Attribute" = 'Determination' OR "Attribute" = 'Off The Ball' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Work Rate' )
CREATE VIEW "CM_D" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'First Touch' OR "Attribute" = 'Heading' OR "Attribute" = 'Marking' OR "Attribute" = 'Passing' OR "Attribute" = 'Tackling' OR "Attribute" = 'Decisions' OR "Attribute" = 'Determination' OR "Attribute" = 'Positioning' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Work Rate' )
CREATE VIEW "CM_SAu" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'First Touch' OR "Attribute" = 'Long Shots' OR "Attribute" = 'Marking' OR "Attribute" = 'Passing' OR "Attribute" = 'Tackling' OR "Attribute" = 'Creativity' OR "Attribute" = 'Decisions' OR "Attribute" = 'Determination' OR "Attribute" = 'Off The Ball' OR "Attribute" = 'Positioning' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Work Rate' )
CREATE VIEW "DF_A" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'Finishing' OR "Attribute" = 'Marking' OR "Attribute" = 'Tackling' OR "Attribute" = 'Anticipation' OR "Attribute" = 'Composure' OR "Attribute" = 'Off The Ball' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Work Rate' OR "Attribute" = 'Stamina' OR "Attribute" = 'Strength' )
CREATE VIEW "DF_S" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'First Touch' OR "Attribute" = 'Long Shots' OR "Attribute" = 'Marking' OR "Attribute" = 'Passing' OR "Attribute" = 'Tackling' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Work Rate' OR "Attribute" = 'Pace' OR "Attribute" = 'Stamina' OR "Attribute" = 'Strength' )
CREATE VIEW "DLP_D" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'Marking' OR "Attribute" = 'Passing' OR "Attribute" = 'Tackling' OR "Attribute" = 'Technique' OR "Attribute" = 'Composure' OR "Attribute" = 'Creativity' OR "Attribute" = 'Decisions' OR "Attribute" = 'Positioning' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Strength' )
CREATE VIEW "DLP_S" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'First Touch' OR "Attribute" = 'Passing' OR "Attribute" = 'Tackling' OR "Attribute" = 'Technique' OR "Attribute" = 'Composure' OR "Attribute" = 'Creativity' OR "Attribute" = 'Decisions' OR "Attribute" = 'Off The Ball' OR "Attribute" = 'Positioning' OR "Attribute" = 'Teamwork' )
CREATE VIEW "DM_D" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'Marking' OR "Attribute" = 'Tackling' OR "Attribute" = 'Concentration' OR "Attribute" = 'Decisions' OR "Attribute" = 'Positioning' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Work Rate' OR "Attribute" = 'Acceleration' OR "Attribute" = 'Stamina' OR "Attribute" = 'Strength' )
CREATE VIEW "DM_S" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'Marking' OR "Attribute" = 'Passing' OR "Attribute" = 'Tackling' OR "Attribute" = 'Decisions' OR "Attribute" = 'Positioning' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Work Rate' OR "Attribute" = 'Acceleration' OR "Attribute" = 'Stamina' OR "Attribute" = 'Strength' )
CREATE VIEW "DW_SA" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'Crossing' OR "Attribute" = 'Dribbling' OR "Attribute" = 'Marking' OR "Attribute" = 'Tackling' OR "Attribute" = 'Technique' OR "Attribute" = 'Decisions' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Work Rate' OR "Attribute" = 'Pace' OR "Attribute" = 'Stamina' )
CREATE VIEW "IF_A" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'Crossing' OR "Attribute" = 'Dribbling' OR "Attribute" = 'Finishing' OR "Attribute" = 'Passing' OR "Attribute" = 'Decisions' OR "Attribute" = 'Flair' OR "Attribute" = 'Off The Ball' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Acceleration' OR "Attribute" = 'Pace' )
CREATE VIEW "IF_S" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'Dribbling' OR "Attribute" = 'Long Shots' OR "Attribute" = 'Passing' OR "Attribute" = 'Technique' OR "Attribute" = 'Decisions' OR "Attribute" = 'Flair' OR "Attribute" = 'Off The Ball' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Acceleration' OR "Attribute" = 'Pace' )
CREATE VIEW "T_A" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'Finishing' OR "Attribute" = 'First Touch' OR "Attribute" = 'Passing' OR "Attribute" = 'Technique' OR "Attribute" = 'Anticipation' OR "Attribute" = 'Composure' OR "Attribute" = 'Creativity' OR "Attribute" = 'Flair' OR "Attribute" = 'Off The Ball' OR "Attribute" = 'Agility' )
CREATE VIEW "WM_DSAAu" ("Attribute","Type","Category") AS SELECT  "AttributesOutfield"."Attribute","AttributesOutfield"."Type","AttributesOutfield"."Category"  FROM "AttributesOutfield" WHERE ( "Attribute" = 'Crossing' OR "Attribute" = 'Passing' OR "Attribute" = 'Tackling' OR "Attribute" = 'Anticipation' OR "Attribute" = 'Decisions' OR "Attribute" = 'Determination' OR "Attribute" = 'Off The Ball' OR "Attribute" = 'Teamwork' OR "Attribute" = 'Work Rate' OR "Attribute" = 'Stamina' )
...
INSERT INTO "Positions_To_Roles" VALUES('Attacking Midfielder','Left','Defensive Winger','Attack','DW_SA')
INSERT INTO "Positions_To_Roles" VALUES('Attacking Midfielder','Left','Defensive Winger','Support','DW_SA')
...
INSERT INTO "Positions_To_Roles" VALUES('Attacking Midfielder','Left','Winger','Attack','W_SA')
INSERT INTO "Positions_To_Roles" VALUES('Attacking Midfielder','Left','Winger','Support','W_SA')
...
INSERT INTO "Positions_To_Roles" VALUES('Attacking Midfielder','Right','Defensive Winger','Attack','DW_SA')
INSERT INTO "Positions_To_Roles" VALUES('Attacking Midfielder','Right','Defensive Winger','Support','DW_SA')
...
INSERT INTO "Positions_To_Roles" VALUES('Attacking Midfielder','Right','Winger','Attack','W_SA')
INSERT INTO "Positions_To_Roles" VALUES('Attacking Midfielder','Right','Winger','Support','W_SA')
...
INSERT INTO "Positions_To_Roles" VALUES('Defender','Left','Full Back','Automatic','FB_SAu')
INSERT INTO "Positions_To_Roles" VALUES('Defender','Left','Full Back','Defend','FB_D')
INSERT INTO "Positions_To_Roles" VALUES('Defender','Left','Full Back','Support','FB_SAu')
INSERT INTO "Positions_To_Roles" VALUES('Defender','Left','Wing Back','Attack','WB_A')
INSERT INTO "Positions_To_Roles" VALUES('Defender','Left','Wing Back','Automatic','WB_SAu')
INSERT INTO "Positions_To_Roles" VALUES('Defender','Left','Wing Back','Defend','WB_D')
INSERT INTO "Positions_To_Roles" VALUES('Defender','Left','Wing Back','Support','WB_SAu')
INSERT INTO "Positions_To_Roles" VALUES('Defender','Right','Full Back','Attack','FB_A')
INSERT INTO "Positions_To_Roles" VALUES('Defender','Right','Full Back','Automatic','FB_SAu')
INSERT INTO "Positions_To_Roles" VALUES('Defender','Right','Full Back','Defend','FB_D')
INSERT INTO "Positions_To_Roles" VALUES('Defender','Right','Full Back','Support','FB_SAu')
INSERT INTO "Positions_To_Roles" VALUES('Defender','Right','Wing Back','Attack','WB_A')
INSERT INTO "Positions_To_Roles" VALUES('Defender','Right','Wing Back','Automatic','WB_SAu')
INSERT INTO "Positions_To_Roles" VALUES('Defender','Right','Wing Back','Defend','WB_D')
INSERT INTO "Positions_To_Roles" VALUES('Defender','Right','Wing Back','Support','WB_SAu')
...
INSERT INTO "Positions_To_Roles" VALUES('Goalkeeper','None','Sweeper Keeper','Attack','SWK_DSA')
INSERT INTO "Positions_To_Roles" VALUES('Goalkeeper','None','Sweeper Keeper','Defend','SWK_DSA')
INSERT INTO "Positions_To_Roles" VALUES('Goalkeeper','None','Sweeper Keeper','Support','SWK_DSA')
...
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Centre','Central Midfielder','Automatic','CM_SAu')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Centre','Central Midfielder','Defend','CM_D')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Centre','Central Midfielder','Support','CM_SAu')
...
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Left','Defensive Winger','Attack','DW_SA')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Left','Defensive Winger','Support','DW_SA')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Left','Wide Midfielder','Attack','WM_DSAAu')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Left','Wide Midfielder','Automatic','WM_DSAAu')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Left','Wide Midfielder','Defend','WM_DSAAu')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Left','Wide Midfielder','Support','WM_DSAAu')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Left','Winger','Attack','W_SA')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Left','Winger','Support','W_SA')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Right','Defensive Winger','Attack','DW_SA')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Right','Defensive Winger','Support','DW_SA')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Right','Wide Midfielder','Attack','WM_DSAAu')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Right','Wide Midfielder','Automatic','WM_DSAAu')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Right','Wide Midfielder','Defend','WM_DSAAu')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Right','Wide Midfielder','Support','WM_DSAAu')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Right','Winger','Attack','W_SA')
INSERT INTO "Positions_To_Roles" VALUES('Midfielder','Right','Winger','Support','W_SA')
INSERT INTO "Positions_To_Roles" VALUES('Striker','Centre','Advanced Forward','Attack','AF_A')
INSERT INTO "Positions_To_Roles" VALUES('Striker','Centre','Complete Forward','Attack','CF_SA')
INSERT INTO "Positions_To_Roles" VALUES('Striker','Centre','Complete Forward','Support','CF_SA')
...
INSERT INTO "Positions_To_Roles" VALUES('Sweeper','None','Sweeper','Defend','SWK_DSA')
INSERT INTO "Positions_To_Roles" VALUES('Wing Back','Left','Wing Back','Attack','WB_A')
INSERT INTO "Positions_To_Roles" VALUES('Wing Back','Left','Wing Back','Automatic','WB_SAu')
INSERT INTO "Positions_To_Roles" VALUES('Wing Back','Left','Wing Back','Defend','WB_D')
INSERT INTO "Positions_To_Roles" VALUES('Wing Back','Left','Wing Back','Support','WB_SAu')
INSERT INTO "Positions_To_Roles" VALUES('Wing Back','Right','Wing Back','Attack','WB_A')
INSERT INTO "Positions_To_Roles" VALUES('Wing Back','Right','Wing Back','Automatic','WB_SAu')
INSERT INTO "Positions_To_Roles" VALUES('Wing Back','Right','Wing Back','Defend','WB_D')
INSERT INTO "Positions_To_Roles" VALUES('Wing Back','Right','Wing Back','Support','WB_SAu')
